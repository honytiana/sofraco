...
exports.readExcelSMATISMCMS = async (file) => {
    ...
    // }
    const arrReg = {
        debutPeriodeCotisation: /^\s*Début\s*de\s*période\s*de\s*cotisation\s*$/i,
        finDePeriodeCotisation: /^\s*Fin\s*de\s*période\s*de\s*cotisation\s*$/i,
        nomGarantie: /^\s*Nom\s*de\s*la\s*garantie\s*$/i,
        souscripteurContratGroupe: /^\s*Souscripteur\s*du\s*contrat\s*groupe\s*$/i,
        numPayeur: /^\s*N°\s*payeur\s*$/i,
        nomPayeur: /^\s*Nom\s*payeur\s*$/i,
        codeCourtier: /^\s*Code\s*courtier\s*$/i,
        nomCourtier: /^\s*Nom\s*du\s*courtier\s*$/i,
        numContratGroupe: /^\s*N°\s*de\s*contrat\s*groupe\s*$/i,
        dateDebutContratAdhesion: /^\s*Date\s*début\s*contrat\s*ou\s*d'adhésion\s*$/i,
        statusContratAdhesion: /^\s*Statut\s*contrat\s*ou\s*adhésion\s*$/i,
        dateFinContratAdhesion: /^\s*Date\s*fin\s*contrat\s*ou\s*adhésion\s*$/i,
        etapeImpaye: /^\s*Etape\s*impayé\s*[/]\s*Motif\s*de\s*résilation\s*$/i,
        periodiciteCotisation: /^\s*Périodicité\s*cotisation\s*$/i,
        cotisationPayeePeriodeTTC: /^\s*Cotisation\s*payée\s*Période\s*TTC\s*$/i,
        cotisationPayeePeriodeHT: /^\s*Cotisation\s*payée\s*Période\s*HT\s*$/i,
        taux: /^\s*Taux\s*$/i,
        typeCommission: /^\s*Type\s*de\s*commission\s*$/i,
        montantCommission: /^\s*Montant\s*commission\s*$/i,
        courtier: /^\s*COURTIER$/i,
        fondateur: /^\s*FONDATEUR$/i,
        sogeas: /^\s*SOGEAS$/i,
